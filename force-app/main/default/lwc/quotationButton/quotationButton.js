...
export default class QuotationButton extends NavigationMixin(LightningElement) {
    ...
    handleViewPdf() {
        const url = `/apex/QuotationTemplate?id=${this.recordId}&selectedItems=${this.selectedItems.join(',')}`;
    ...
    get pdfIframeUrl() {
        return `/apex/QuotationTemplate?id=${this.recordId}&selectedItems=${this.selectedItems.join(',')}`;
    }
}